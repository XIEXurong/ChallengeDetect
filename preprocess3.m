...
%     load(['data_preprocess2/',name_str,'_featNlab.mat']);
    ...
    data_channels = load(['data_preprocess2/',name_str,'_process2.mat']);
    ...
    clear data_channels;
    [event, Penh] = readtxttable_all(['data_preprocess2/',name_str, '.txt']);
    [time,event] = process_event_txt(event);
    data_rr = load(['data_preprocess2/','HRV_Tachogram_of_', name_str,'.mat']);
    data_itrr = load(['data_preprocess2/','HRV_Interpolated_RR_of_', name_str,'.mat']);
